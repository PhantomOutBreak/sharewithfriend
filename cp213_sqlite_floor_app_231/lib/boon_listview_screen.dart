...
class _BoonListViewScreenState extends State<BoonListViewScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 12, 102, 36),
      appBar: AppBar(
        title: Text(
          'Boon ListView',
          style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold),
        ),
        backgroundColor: const Color.fromARGB(255, 67, 8, 108),
        centerTitle: true,
        actions: [
          IconButton(
            onPressed: () {
            ...
            return Padding(
              ...
              child: ListView.separated(
                itemBuilder: (context, index) {
                  ...
                  return Card(
                    color: const Color.fromARGB(255, 230, 239, 134),
                    child: ListTile(
                      leading: IconButton(
                        icon: CircleAvatar(
                          backgroundColor: const Color.fromARGB(255, 47, 207, 210),
