...
class _BoonFormScreenState extends State<BoonFormScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        backgroundColor: const Color.fromARGB(255, 0, 165, 140),
        centerTitle: true,
      ),
      body: Center(
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color.fromARGB(255, 7, 43, 161),
          shadowColor: const Color.fromARGB(255, 35, 104, 142),
          elevation: 3,
  ...
  Widget _buildResetButton() {
    return SizedBox(
      ...
      child: ElevatedButton(
        style: ElevatedButton.styleFrom(
          backgroundColor: const Color.fromARGB(255, 26, 72, 152),
          shadowColor: const Color.fromARGB(255, 38, 88, 130),
          elevation: 3,
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(32.0),
          ),
